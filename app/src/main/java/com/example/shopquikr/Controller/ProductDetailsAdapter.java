...
import com.example.shopquikr.View.ProductDescriptionFragment;
import com.example.shopquikr.View.ProductSpecificationFragment;
...
public class ProductDetailsAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        // Differentiate to show product Description, product specification and other details
        switch (position) {
            case 0:
